...
public class Config {
	 ...
	 * 配置文件中系统基础url的key名称
	 */
	public static final String managerInter = "managerInter";
	 ...
	 * 配置文件中系统基础url的key名称
	 */
	public static final String Intercepted_url = "Intercepted";
	 ...
	 * 配置文件中系统基础url的key名称
	 */
	public static final String Accestoken_url = "accesstokeninter";
